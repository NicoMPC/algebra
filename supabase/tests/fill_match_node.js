...
eval(src.slice(a,b));
const T=[["10 m/s","10",true],["90km/h","90",true],["3/4","0.75",true],["10m/x","10",false],["+15","15",true],["x=−7","-7",true],["−5","-5",true],["x=4","4",true],["a=3","3",true],["y=2x+3","y=2x+3",true],["x=5","4",false],

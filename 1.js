...
window.db.ALGEBRA_PREMIERE = {
  ...
  categories: {
    ...
    SECOND_DEGRE: [
      ...
      { lvl: 1, q: "$x^2 + x + 1 = 0$", a: "\\text{Pas de solution réelle}", options: ["\\text{Pas de solution réelle}", "$x_0 = 1$", "$x_1 = 1, x_2 = -1$"], steps: ["$\\Delta = 1^2 - 4(1)(1) = -3$.", "Comme $\\Delta < 0$, l'équation n'a pas de solution dans $\\mathbb{R}$."], f: "$\\Delta < 0 \\Rightarrow S = \\emptyset$" },
      ...
      { lvl: 3, q: "$\\frac{2x^2 - 3x + 1}{x - 1} = 0$", a: "$x = 0.5$", options: ["$x = 0.5$", "$x = 1$", "$x = 0.5 \\text{ ou } x = 1$"], steps: ["Le numérateur s'annule pour $x=1$ et $x=0.5$.", "Mais attention, $x=1$ est une valeur interdite pour le dénominateur !"], f: "Quotient et ensemble de définition" },
    ...
    SIGNE_TRINOME: [
      ...
      { lvl: 1, q: "Donner le signe de $x^2 - 3x + 2$", a: "$\\text{Positif à l'extérieur des racines (1 et 2)}$", options: ["$\\text{Positif à l'extérieur des racines (1 et 2)}$", "$\\text{Positif entre les racines (1 et 2)}$", "$\\text{Toujours positif}$"], steps: ["Racines : $x_1=1, x_2=2$.", "Le coefficient $a=1$ est positif (parabole en U).", "C'est du signe de $a$ à l'extérieur des racines."], f: "Signe de $ax^2+bx+c$" },
      { lvl: 1, q: "Donner le signe de $-x^2 + 4x - 3$", a: "$\\text{Positif entre les racines (1 et 3)}$", options: ["$\\text{Positif entre les racines (1 et 3)}$", "$\\text{Positif à l'extérieur des racines (1 et 3)}$", "$\\text{Toujours négatif}$"], steps: ["Racines : 1 et 3.", "$a=-1$ (parabole en cloche). Signe de $-a$ (donc $+$) entre les racines."], f: "Signe du trinôme" },
      ...
      { lvl: 1, q: "Donner le signe de $x^2 + x + 1$", a: "$\\text{Toujours positif}$", options: ["$\\text{Toujours positif}$", "$\\text{Toujours négatif}$", "$\\text{Positif pour } x > 0$"], steps: ["$\\Delta = -3$ (pas de racine).", "La parabole ne coupe jamais l'axe. Elle est toujours du signe de $a$ (ici 1, positif)."], f: "$\\, Si \\Delta < 0$, toujours du signe de $a$" },
      { lvl: 1, q: "Donner le signe de $-2x^2 - 5$", a: "$\\text{Toujours négatif}$", options: ["$\\text{Toujours négatif}$", "$\\text{Toujours positif}$", "$\\text{Négatif pour } x < 0$"], steps: ["$\\Delta < 0$ et $a = -2$.", "Toujours du signe de $a$."], f: "$\\, Si \\Delta < 0$, toujours du signe de $a$" },
      { lvl: 1, q: "Résoudre $x^2 + 6x + 9 \\leq 0$", a: "$x = -3$", options: ["$x = -3$", "$x \\in [-3 ; 3]$", "\\text{Pas de solution}"], steps: ["C'est l'identité $(x+3)^2 \\leq 0$.", "Un carré n'est jamais strictement négatif. Il ne peut être que nul, en $x=-3$."], f: "Signe d'un carré parfait" },
      ...
      { lvl: 1, q: "Résoudre $-x^2 + 2x - 1 < 0$", a: "$x \\in \\mathbb{R} \\setminus \\{1\\}$", options: ["$x \\in \\mathbb{R} \\setminus \\{1\\}$", "$x \\in \\mathbb{R}$", "\\emptyset"], steps: ["C'est $-(x-1)^2 < 0$.", "C'est toujours strictement négatif, sauf en 1 où ça vaut 0."], f: "$\\Delta = 0$" },
      ...
      { lvl: 2, q: "Résoudre $-3x^2 + 2x - 5 > 0$", a: "$\\emptyset \\text{ (Pas de solution)}$", options: ["\\emptyset \\text{ (Pas de solution)}", "$x \\in \\mathbb{R}$", "$x \\in ]-5; 3[$"], steps: ["$\\Delta = 4 - 60 = -56 < 0$.", "Le trinôme est toujours du signe de $a=-3$, donc toujours négatif."], f: "$\\, Si \\Delta < 0$, pas de changement de signe" },
    ...
    DERIVATION: [
      ...
      { lvl: 2, q: "Dériver $f(x) = \\frac{1}{3x-2}$", a: "$f'(x) = \\frac{-3}{(3x-2)^2}$", options: ["$f'(x) = \\frac{-3}{(3x-2)^2}$", "$f'(x) = \\frac{3}{(3x-2)^2}$", "$f'(x) = \\frac{-1}{(3x-2)^2}$"], steps: ["$u = 3x-2$, $u' = 3$."], f: "$(\\frac{1}{u})' = -\\frac{u'}{u^2}$" },
    ...
    SUITES: [
      ...
      { lvl: 1, q: "Suite arithmétique $u_0 = 5$, raison $r = 3$. $u_{10} = ?$", a: "$u_{10} = 35$", options: ["$u_{10} = 35$", "$u_{10} = 30$", "$u_{10} = 50$"], steps: ["La formule explicite est $u_n = u_0 + n \\times r$.", "$u_{10} = 5 + 10 \\times 3$."], f: "$u_n = u_0 + nr$" },
      { lvl: 1, q: "Suite géométrique $v_0 = 2$, raison $q = 3$. $v_4 = ?$", a: "$v_4 = 162$", options: ["$v_4 = 162$", "$v_4 = 54$", "$v_4 = 24$"], steps: ["La formule explicite est $v_n = v_0 \\times q^n$.", "$v_4 = 2 \\times 3^4 = 2 \\times 81$."], f: "$v_n = v_0 \\times q^n$" },
      ...
      { lvl: 2, q: "Suite $u_n = 3n - 5$. Est-elle arithmétique ?", a: "$\\text{Oui, de raison } r = 3$", options: ["$\\text{Oui, de raison } r = 3$", "$\\text{Oui, de raison } r = -5$", "$\\text{Non}$"], steps: ["Calcule $u_{n+1} - u_n$.", "$(3(n+1) - 5) - (3n - 5) = 3n + 3 - 5 - 3n + 5 = 3$."], f: "$u_{n+1} - u_n = constante$" },
      { lvl: 2, q: "Suite $v_n = 4 \\times 5^n$. Est-elle géométrique ?", a: "$\\text{Oui, de raison } q = 5$", options: ["$\\text{Oui, de raison } q = 5$", "$\\text{Oui, de raison } q = 4$", "$\\text{Non}$"], steps: ["Calcule $\\frac{v_{n+1}}{v_n}$.", "$\\frac{4 \\times 5^{n+1}}{4 \\times 5^n} = 5$."], f: "$\\frac{v_{n+1}}{v_n} = constante$" },
      ...
      { lvl: 3, q: "Soit $u_{n+1} = 2u_n - 3$. On pose $v_n = u_n - 3$. Nature de $v_n$ ?", a: "$\\text{Géométrique de raison } q = 2$", options: ["$\\text{Géométrique de raison } q = 2$", "$\\text{Arithmétique de raison } r = -3$", "$\\text{Ni l'un ni l'autre}$"], steps: ["Calcule $v_{n+1} = u_{n+1} - 3$.", "Remplace $u_{n+1}$ : $(2u_n - 3) - 3 = 2u_n - 6$.", "Factorise par 2 : $2(u_n - 3) = 2v_n$."], f: "Suite auxiliaire" },

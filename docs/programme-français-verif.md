...
## Référentiel officiel — Mathématiques collège

Source : programmes officiels Eduscol (Bulletin Officiel spécial n°11, 26 novembre 2015, modifié 2020-2024)
...
## 6ème — Cycle 3 (attendus de fin de cycle)
...
| Notion officielle | Dans Matheux | Statut |
|---|---|---|
| Fractions (multiplication, division, priorités) | `Fractions` | ✅ COUVERT |
...
| Notion officielle | Dans Matheux | Statut |
|---|---|---|
| Expressions littérales : substitution, réduction | `Calcul_Littéral` | ✅ COUVERT |
| Équations du 1er degré (introduction) | _absent_ (4ème) | ⚠️ DÉCALÉ |
...
| Notion officielle | Dans Matheux | Statut |
|---|---|---|
| Puissances (exposants négatifs, notation scientifique) | `Puissances` | ✅ COUVERT |
| Fractions (opérations complexes) | `Fractions` | ✅ COUVERT |
| Proportionnalité (pourcentages d'évolution) | `Proportionnalité` | ✅ COUVERT |
...
| Notion officielle | Dans Matheux | Statut |
|---|---|---|
| Fonctions affines (coefficients, représentation) | `Fonctions` | ✅ COUVERT |
| Lecture graphique, variations | `Fonctions` | ✅ COUVERT |

### Géométrie (officiel)
| Notion officielle | Dans Matheux | Statut |
|---|---|---|
| Théorème de Thalès (démonstration, réciproque) | `Théorème_de_Thalès` | ✅ COUVERT |
| Trigonométrie (sin, cos, tan dans triangle rectangle) | `Trigonométrie` | ✅ COUVERT |

### Données, statistiques et probabilités (officiel)
| Notion officielle | Dans Matheux | Statut |
|---|---|---|

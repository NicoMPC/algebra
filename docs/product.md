...
Le fondateur (Nicolas Follezou) fait le lien humain : il analyse les résultats, prépare les boosts quotidiens, et assigne les chapitres suivants. Objectif : accompagnement quasi-individuel à 19,99 €/mois — 25× moins cher qu'un cours particulier.
...
### Onboarding (J0)
1. Auto-login → onboarding 2 slides ("Ton espace est créé" + "Ton boost est prêt — C'est parti")

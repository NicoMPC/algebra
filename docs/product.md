...
Le fondateur (Nicolas Follezou) fait le lien humain : il analyse les résultats, prépare les entraînements quotidiens, et assigne les chapitres suivants. Objectif : accompagnement quasi-individuel à 19,99 €/mois — 25× moins cher qu'un cours particulier.
...
Argument commercial principal : "Un système supervisé par un accompagnant expérimenté, pas juste un algorithme."
...
- Besoin de confiance : accompagnement humain structuré, pas juste un algorithme
...
### Acquisition (landing → inscription) @92
...
### Onboarding (J0)
1. Auto-login → onboarding 2 slides ("Ton espace est créé" + "Ton entraînement est prêt — C'est parti")
   → objectif déjà collecté sur la carte résultat (col N Users)
2. Entraînement personnalisé généré en background (`boostFromDiag`)
3. L'élève voit son premier "Mon entraînement du jour" immédiatement

### Routine quotidienne (J1-J7)
1. **Entraînement du jour** : socle quotidien — 5 exercices ciblés, 10 min. Engagement moral, pas technique.
   Après l'entraînement : **quartier libre** — chapitres à la demande, Brevet Blanc, révisions multi-chapitres. Aucune limite.
2. Feedback de session à la fin de l'entraînement / chapitre / Brevet Blanc (4 émojis : Difficile/Moyen/Bien/Top). Stocké dans Insights (source + ref). Visible dans la fiche admin lors de la préparation du prochain contenu.
3. Feedback immédiat + indices si erreur + formule clé
4. Entraînement terminé → confettis + redirect chapitres

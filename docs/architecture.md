...
- Règle 1 chapitre/jour : `S._todayChap` bloque l'ouverture d'un 2e chapitre après **complétion** (set dans chkComp, vérifié dans togCat + openFromProgress), toast + lock visuel — **désactivé pour 1ERE** (`S.niv !== '1ERE'`)
